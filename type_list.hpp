...
namespace cov {
	...
	template<int posit,typename fT,typename sT,typename tT>struct erase<posit,tlist_node<fT,tlist_node<sT,tT>>>{
		using result=tlist_node<fT,typename erase<posit-1,tlist_node<sT,tT>>::result>;
	};
	template<typename fT,typename sT>struct erase<0,tlist_node<fT,sT>>{
		using result=sT;
	};
	/*template<typename fT,typename sT>struct erase<1,tlist_node<fT,sT>>{
		using result=fT;
	};*/
